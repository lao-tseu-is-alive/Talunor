...
- **Version:** `v0.10.8` (learning course — complete; French translation: 00–08)
...
│   │   │                     #       (turn / fact / doc_chunk); Hit type; Forget.
...
│   │   └── agent_test.go     #     Tests (recall+store, approval allow/deny, tool-loop cap, reflection).
│   │
