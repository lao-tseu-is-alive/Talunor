...
> Current version: **v0.18.2** — a correctness & hardening patch (see CHANGELOG:
> deterministic temperature, soft-forgotten-fact consolidation, a bounded async
> shutdown, an inspectable approval prompt, OCI-sandbox capability drop, and two SSRF
> gaps closed). Built on Iterations 1–3 (Layers 1–13), plus Layer 14
